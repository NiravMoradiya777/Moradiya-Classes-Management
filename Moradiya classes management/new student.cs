...
namespace Moradiya_classes_management
{
    public partial class new_student : Form
    {
        ...
        {//for student id
            ...
            if(Student_ID.Text=="Student ID")
            {
                Student_ID.Text = "";
            }
            label2.Visible = true;
            label8.BackColor = Color.FromArgb(33, 169, 225);
            Student_ID.ForeColor = Color.FromArgb(48, 54, 65);
        ...
        {//for class
            ...
            Class.ForeColor = Color.FromArgb(48, 54, 65);
        ...
        private void new_student_Load(object sender, EventArgs e)
        {
            ...
            int a = d.give_new_id("s_id", "student");
            Student_ID.Text = a.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string imgpath = null;
            if (First_Name.Text == null || Middle_Name.Text == null || Last_Name.Text == null || Birth_Date.Text == null || Address.Text == null || Gender.Text == null || Class.Text == null || Mobile_No_1.Text == null || First_Name.Text == "First Name" || Middle_Name.Text == "Middle Name" || Last_Name.Text == "Last Name" || Birth_Date.Text == "Birth Date" || Address.Text == "Address" || Gender.Text == "Gender" || Class.Text == "Class" || Mobile_No_1.Text == "Mobile No 1")
            {
                if (First_Name.Text != null && Middle_Name.Text != null && Last_Name.Text != null && Birth_Date.Text != null && Address.Text != null && Gender.Text != null && Class.Text != null && Mobile_No_1.Text == null && Mobile_No_2.Text != null)
                {
                    if (Mobile_No_2.Text != "Mobile No 2")
                    {
                ...
                else if (First_Name.Text != "First Name" && Middle_Name.Text != "Middle Name" && Last_Name.Text != "Last Name" && Birth_Date.Text != "Birth Date" && Address.Text != "Address" && Gender.Text != "Gender" && Class.Text != "Class" && Mobile_No_1.Text == "Mobile No 1" && Mobile_No_2.Text == "Mobile No 2")
                {
                    MessageBox.Show("Mobile No 1 is mendetory");
                }
                else if (First_Name.Text != "First Name" && Middle_Name.Text != "Middle Name" && Last_Name.Text != "Last Name" && Birth_Date.Text != "Birth Date" && Address.Text != "Address" && Gender.Text != "Gender" && Class.Text != "Class" && Mobile_No_1.Text == "Mobile No 1" && Mobile_No_2.Text != "Mobile No 2")
            ...
            else if ((Class.Text == "1" || Class.Text == "2" || Class.Text == "3" || Class.Text == "4" || Class.Text == "5" || Class.Text == "6" || Class.Text == "7" || Class.Text == "8" || Class.Text == "9" || Class.Text == "10" || Class.Text == "11-com" || Class.Text == "12-com" || Class.Text == "11-sci" || Class.Text == "12-sci") && (Gender.Text == "Male" || Gender.Text == "Female") && (Mobile_No_1.Text.Length == 10 || Mobile_No_2.Text.Length == 10))
            {
                ...
                {
                    image_path.Text = Application.StartupPath.Substring(0,(Application.StartupPath.Length-10))+ "\\Resources\\student1.png";
                    
                }
                imgpath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\Classes Management\\student\\" + First_Name.Text + " " + Last_Name.Text + ".jpg";
                    ...
                    try
                    {
                        ...
                        if (Mobile_No_2.Text == null || Mobile_No_2.Text == "Mobile No 2" || Mobile_No_2.Text == "")
                        {
                            ...
                            d.add_new_student(Student_ID.Text, imgpath, First_Name.Text, Last_Name.Text, Middle_Name.Text, Birth_Date.Text, Gender.Text, Address.Text, Class.Text, Convert.ToInt64(Mobile_No_1.Text), mobilenodefault);
                            File.Copy(image_path.Text, imgpath); //hear name of image.jpg);
                            MessageBox.Show("Insert student success full");
                        ...
                        else
                        {
                            ...
                            {
                                d.add_new_student(Student_ID.Text, imgpath, First_Name.Text, Last_Name.Text, Middle_Name.Text, Birth_Date.Text, Address.Text, Gender.Text, Class.Text, Convert.ToInt64(Mobile_No_1.Text), Convert.ToInt64(Mobile_No_2.Text));
                                File.Copy(image_path.Text, imgpath); //hear name of image.jpg);
                                MessageBox.Show("Insert student success full");
                                foreach (Form frm in this.MdiChildren)
                                {
